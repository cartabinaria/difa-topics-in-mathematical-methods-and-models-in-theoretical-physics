...
\input{sezioni/1-relativita-ristretta}
\newpage

\input{sezioni/2-elettromagnetismo.tex}
\newpage

\input{sezioni/3-fluidi-perfetti.tex}
\newpage

\input{sezioni/4-teoria-dei-gruppi.tex}
\newpage

\input{sezioni/5-teoria-dei-campi.tex}
